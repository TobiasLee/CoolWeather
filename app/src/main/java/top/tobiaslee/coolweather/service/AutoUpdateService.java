package top.tobiaslee.coolweather.service;
...
import top.tobiaslee.coolweather.WeatherActivity;
...
public class AutoUpdateService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        int anHour = 8 * 60 * 60 * 1000 ;// ms of 8 hours
    ...
    private void updateWeather() {
        ...
        if(weatherString != null ) {
            ...
            String weatherUrl = WeatherActivity.ADDRESS + weatherId + WeatherActivity.KEY;
